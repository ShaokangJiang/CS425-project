...
<br></br>
 ...
 <form action = "Create_userCh.jsp" method = "post" onsubmit = "return validate()">  
<div class="row">
...
<div class="input-field col s12">
  ...
  <a class="waves-effect waves-light btn blue" href="admin.jsp?id=<%=id %>"><i class="material-icons prefix">arrow_back</i>Go back</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <button class="waves-effect waves-light btn" id="submit"><i class="material-icons prefix">add</i>Add user</button>
