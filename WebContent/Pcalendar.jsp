...
Time
        ...
        <% 
        PreparedStatement pStmt3 = conn.prepareStatement("select Reserved, dbo.Employee.ID, First_Name, Last_Name from dbo.calendar join dbo.Employee on dbo.calendar.ID=dbo.Employee.ID where dbo.calendar.patient_id='"+ id +"'");  
 	   ResultSet rs3 = pStmt3.executeQuery();
    	  while(rs3.next()){
    		  String name_ = "ID:"+rs3.getString(2)+" "+rs3.getString("First_Name")+" "+rs3.getString("Last_Name");
    %>
        ...
        <br></br>
  <a class="waves-effect waves-light btn blue" href="patient.jsp?id=<%=id %>"><i class="material-icons prefix">arrow_back</i>Go back</a>
