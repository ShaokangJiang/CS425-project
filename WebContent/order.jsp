...
<br></br>
 ...
 <form action = "orderCh.jsp" method = "post" onsubmit = "return validate()">  
<div class="row">
        ...
        <div class="col s10 m8 l8">
          <div class="card white z-depth-3">
            <div class="card-content black-text">
              <span class="card-title"><i class="material-icons prefix">find_in_page</i>pick the one you want to create an order</span>
      ...
      <label for="myInput">Search for last name...</label>
      </div>
...
Select
        ...
        <% 
        PreparedStatement pStmt3 = conn.prepareStatement("select * from dbo.patient");  
    ...
    %>
      ...
      <label for="test<%=hs %>">Patient ID: <%=rs3.getInt(1) %></label>
    </p>
