...
<html>  
  ...
  <body>  
    <%      
            ...
            String addr = Addr1+","+Addr2+","+City+","+State+","+zip;
            ...
            PreparedStatement tmt = conn.prepareStatement("Insert into dbo.login(Privilege,Password) values('" +"patient"+ "','" +Password+ "')",Statement.RETURN_GENERATED_KEYS);  
            ...
            PreparedStatement tmt1 = conn.prepareStatement("Insert into dbo.Patient values('" +id+ "','" +First+ "','" +Last+ "','" +addr +"')");  
            rst = tmt1.executeUpdate();
            rs.close();
            conn.close();
            	%>
            	<jsp:forward page="Create_patient.jsp">
