...
<br></br>
 ...
 <form action = "updateCh1.jsp" method = "post" onsubmit = "return validate()">  
<div class="row">
        ...
        <div class="col s10 m8 l8">
          <div class="card white z-depth-3">
            <div class="card-content black-text">
              <span class="card-title"><i class="material-icons prefix">create</i>Edit some value based on current</span>
...
<div class="input-field col s6">
          ...
          <input id="icon_prefix" type="text" name="First" class="validate" value="<%=rs2.getString(2) %>">
          <label for="icon_prefix">First Name</label>
        </div>
        <div class="input-field col s6">
          <input id="icon_prefix1" type="text" name="Last" class="validate" value="<%=rs2.getString(3) %>" >
          <label for="icon_prefix1">Last name</label>
        </div>
        
        <div class="input-field col s12">
        <i class="material-icons prefix">location_city</i>
          <input id="icon_first" type="text" name="Addr" class="validate" value="<%=rs2.getString("Address")%>" >
          <label for="icon_first">Address</label>
        </div>
