...
Time
        ...
        <% 
        PreparedStatement pStmt3 = conn.prepareStatement("select Reserved, patient_id, First_Name, Last_Name from dbo.calendar join dbo.Patient on dbo.calendar.patient_id=dbo.Patient.ID where dbo.calendar.ID='"+ id +"'");  
 	   ResultSet rs3 = pStmt3.executeQuery();
    	  while(rs3.next()){
    		  String name_ = "ID:"+rs3.getString("patient_id")+" "+rs3.getString("First_Name")+" "+rs3.getString("Last_Name");
    %>
