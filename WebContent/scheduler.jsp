...
<%    
  ...
  //Connect to database
  PreparedStatement pStmt1 = conn.prepareStatement("select * from dbo.Employee where id = '" + id + "' and jobtype = '" + "Scheduler" +"'");  
...
<div class="row">
      ...
      <a class="waves-effect waves-light btn blue" href="schedule.jsp?id=<%=id %>&web=scheduler">Make appointment with medical staff</a>
  &nbsp;&nbsp;  <a class="waves-effect waves-light btn blue" href="view_order_sc.jsp?id=<%=id %>&web=scheduler">View the orders</a>
       <br></br>
        <a class="waves-effect waves-light btn blue" href="view_bills_sc.jsp?id=<%=id %>&web=scheduler">View bills</a>
        &nbsp;&nbsp;    <a class="waves-effect waves-light btn blue" href="view_calendar_sc.jsp?id=<%=id %>&web=scheduler">View calendar </a>
</div>
        </div>
            </div>
            </div>
