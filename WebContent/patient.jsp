...
<div class="row">
     ...
     <a class="waves-effect waves-light btn blue" href="view_order.jsp?id=<%=id %>&web=patient">View the orders</a>
        &nbsp;&nbsp; 
        <a class="waves-effect waves-light btn blue" href="view_bills.jsp?id=<%=id %>&web=patient">View bills</a>
          &nbsp;&nbsp; 
        <a class="waves-effect waves-light btn blue" href="Pcalendar.jsp?id=<%=id %>&web=patient">View Calendar</a>
</div>
        </div>
            </div>
            </div>
