...
<%    
  ...
  if(rs2.next()){
	  ...
	  if(!diagnostic.equals("-1")){
		  rs1.close();
		  pStmt1.close();
		  conn.close();
		  %>
		  <jsp:forward page="orderCh2.jsp">
          <jsp:param name="id" value="<%=id %>"/> 
          <jsp:param name="patient_id" value="<%=patient_id %>"/> 
          <jsp:param name="diagnostic" value="<%=diagnostic %>"/> 
          </jsp:forward>
		  <%
	  }
  %>
...
<br></br>
 ...
 <form action = "orderCh2.jsp" method = "post" onsubmit = "return validate()">  
<div class="row">
        ...
        <div class="col s10 m8 l8">
          <div class="card white z-depth-3">
            <div class="card-content black-text">
              <span class="card-title"><i class="material-icons prefix">create</i>More info about this new diagnostic</span>
              <span class="red-text"><%=h%></span>      
          </div>
      <div class="card-action">
      
        <div class="input-field col s6">
          <input id="cost" class="validate" type="text" name="cost" value="" onkeyup="value=value.replace(/[^\d]/g,'')"> 
