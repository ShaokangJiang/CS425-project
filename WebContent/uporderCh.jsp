...
<br></br>
 ...
 <form action = "uporderCh1.jsp" method = "post" onsubmit = "return validate()">  
<div class="row">
        ...
        <div class="col s10 m8 l8">
          <div class="card white z-depth-3">
            <div class="card-content black-text">
              <span class="card-title"><i class="material-icons prefix">create</i>Add some info to mark this order complete</span>
      ...
      <div class="card-action">
          ...
          <div class="input-field col s12">
            <textarea id="textarea2" name="Comments" class="materialize-textarea" data-length="47"></textarea>
            <label for="textarea2">Comments</label>
          </div>
        </div>
        <input id="id" type="hidden" name="id" class="validate" value=<%=id %>>
        
        <input id="order_id" type="hidden" name="order_id" class="validate" value=<%=order_id %>>
  ...
  <a class="waves-effect waves-light btn blue" href="medicalStaff.jsp?id=<%=id %>"><i class="material-icons prefix">arrow_back</i>Go back</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <button class="waves-effect waves-light btn" id="submit"><i class="material-icons prefix">arrow_forward</i>Complete</button>
