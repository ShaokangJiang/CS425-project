...
<%    
    ...
    try{  
          ...
          if(request.getParameter("Succe")!=null)  
           	h = "Successfully create order";
    }catch(Exception e){  
        e.printStackTrace();  
    }  
   %>  
...
<div class="row">
      ...
      <a class="waves-effect waves-light btn blue" href="schedule.jsp?id=<%=id %>&web=medicalStaff">Make appointment with medical staff</a>
  &nbsp;&nbsp;  <a class="waves-effect waves-light btn blue" href="order.jsp?id=<%=id %>">Create an Order</a>
  
       <br></br>
        <a class="waves-effect waves-light btn blue" href="calendar.jsp?id=<%=id %>">View calendar</a>
        &nbsp;&nbsp;    <a class="waves-effect waves-light btn blue" href="update.jsp?id=<%=id %>">View and update patient record</a>
&nbsp;&nbsp;  <a class="waves-effect waves-light btn blue" href="uporder.jsp?id=<%=id %>">Update an Order</a>
</div>
        </div>
            </div>
            </div>
